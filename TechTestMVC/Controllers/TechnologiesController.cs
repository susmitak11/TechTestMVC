...
namespace TechTestMVC.Controllers
{
    ...
    public class TechnologiesController : Controller
    {
        ...
        public TechnologiesController(TechTestMVCDbContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Price")] Technology technology)
        {
            if (id != technology.Id)
            {
                return NotFound();
